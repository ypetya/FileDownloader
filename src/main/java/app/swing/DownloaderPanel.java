...
public class DownloaderPanel extends JPanel {
    ...
    JTextField regex = new JTextField("href=[\"'][^\"']*\\.(mp4|mp3|ogg|avi|inf|nfo|jpg|png|gif)[^\"']*[\"']", 50);
    ...
    public DownloaderPanel() {
        ...
        add(progress);
        panel.add(output);
        sp = new JScrollPane(panel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        add(sp);
    }
